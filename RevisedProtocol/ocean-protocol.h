...
#ifndef OCEAN_PROTOCOL_H
#define OCEAN_PROTOCOL_H
...
///
class OceanProtocol : public Ipv4RoutingProtocol
{
public:
  /**
   ...
   * \param [in] messages
   */
  typedef void (* PacketTxRxTracedCallback)(const PacketHeader & header, const OceanMessageList & messages);
...
private:
   ...
   */
  void SendPacket (Ptr<Packet> packet, const OceanMessageList &containedMessages);
  ...
  olsr::OceanMessageList m_queuedMessages;
   ...
   */
  void ForwardDefault (olsr::OceanMessageHeader olsrMessage,
   ...
   */
  void QueueMessage (const olsr::OceanMessageHeader &message, Time delay);
   ...
   */
  void ProcessHello (const olsr::OceanMessageHeader &msg,
   ...
   *
   */
  void ProcessTc (const olsr::OceanMessageHeader &msg,
                  const Ipv4Address &senderIface);
   ...
   * \param senderIface the address of the interface where the message was sent from.
   */
  void ProcessMid (const olsr::OceanMessageHeader &msg,
                   const Ipv4Address &senderIface);
   ...
   *
   */
  void ProcessHna (const olsr::OceanMessageHeader &msg,
                   const Ipv4Address &senderIface);
   ...
   */
  void LinkSensing (const olsr::OceanMessageHeader &msg,
   ...
   * \param hello The received HELLO sub-message.
   */
  void PopulateNeighborSet (const olsr::OceanMessageHeader &msg,
                            const olsr::OceanMessageHeader::Hello &hello);
   ...
   * \param hello The received HELLO sub-message.
   */
  void PopulateTwoHopNeighborSet (const olsr::OceanMessageHeader &msg,
                                  const olsr::OceanMessageHeader::Hello &hello);
   ...
   * \param hello The received HELLO sub-message.
   */
  void PopulateMprSelectorSet (const olsr::OceanMessageHeader &msg,
                               const olsr::OceanMessageHeader::Hello &hello);
  ...
  /// Rx packet trace.
  TracedCallback <const PacketHeader &, const OceanMessageList &> m_rxPacketTrace;

  /// Tx packet trace.
  TracedCallback <const PacketHeader &, const OceanMessageList &> m_txPacketTrace;
