 ...
 */
#ifndef OCEAN_OLSR_HELPER_H
#define OCEAN_OLSR_HELPER_H
 ...
 */
class OceanOlsrHelper : public Ipv4RoutingHelper
{
public:
  /**
   * Create an OceanOlsrHelper that makes life easier for people who want to install
   * OLSR routing to nodes.
   */
  OceanOlsrHelper ();

  /**
   * \brief Construct an OceanOlsrHelper from another previously initialized instance
   * (Copy Constructor).
   */
  OceanOlsrHelper (const OceanOlsrHelper &);

  /**
   * \returns pointer to clone of this OceanOlsrHelper
   *
...
private:
   ...
   * \return nothing
   */
  OceanOlsrHelper &operator = (const OceanOlsrHelper &);
