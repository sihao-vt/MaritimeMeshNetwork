...
meshSize = 64 ;   % mesh size
patchSize = 80  ; % patch size
direction=45; % wind direction
[windx , windy] = pol2cart( deg2rad(direction) , 1) ; 
windSpeed = 25;     % wind speed
timeStep = 1/10;    % time step between neighbor time slots
Times=200 ;        % total timeslots
...
%infile
file=fopen('ocean_data_64_80_25_0.10_200.txt','wt');
